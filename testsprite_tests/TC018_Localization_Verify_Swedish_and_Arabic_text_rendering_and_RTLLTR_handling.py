...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Hoppa över' button to skip the welcome modal and access the main app interface.
        ...
        frame = context.pages[-1]
        # Click on 'Inställningar / الإعدادات' to open language settings for switching to Arabic
