...
async def run_test():
    ...
    try:
        ...
        # -> Click 'Hoppa över' button to skip the welcome modal and proceed to main app interface.
        frame = context.pages[-1]
        ...
        # -> Click 'Bläddra' (Browse) button to return to Browse Mode and retry filtering test.
        frame = context.pages[-1]
        # Click 'Bläddra' button to return to Browse Mode
