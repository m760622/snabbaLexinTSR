...
## 🚨 Rule #6: Anti-Duplication Protocol (بروتوكول منع التكرار)

> **الأهمية:** 🔴 P0 (Critical)
> **Trigger:** Copy-Paste / Multi-file Edits
> **Lesson Learned:** 2026-01-29 (Duplicate State Declaration Error)

### القاعدة (The Rule)

**يجب التحقق من عدم وجود الكود مسبقاً قبل إضافته.**

1. **State Checks:** عند إضافة  أو ، اقرأ الملف أولاً وتأكد أن المتغير غير موجود.
    *   ❌ **Don't:** نسخ كتلة كود كاملة ولصقها دون النظر للمحتوى الموجود.
    *   ✅ **Do:** ابحث عن  قبل الإضافة.

2. **Tool Awareness:** عند استخدام ، تذكر أنك تقوم بـ "تعديل" وليس "استبدال كامل" إلا إذا حددت ذلك. الإضافة العمياء تؤدي للتكرار.

3. **Self-Correction:** إذا رأيت خطأ مثل `The symbol "X" has already been declared`، توقف فوراً، ولا تحاول "التجربة". اقرأ الملف، وحدد السطر المكرر، واحذفه بدقة.
